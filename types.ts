...
export type ViewMode = 'DASHBOARD' | 'CHAT' | 'TOOLS_CALC' | 'PROFILE' | 'AUTH' | 'SETTINGS' | 'HISTORY' | 'TRIBES' | 'SUPPORT' | 'INBOX' | 'NOTIFICATIONS' | 'CAREER' | 'EDUCATION' | 'RELATIONSHIPS_DASH' | 'MENTAL_HEALTH' | 'FORBES';
